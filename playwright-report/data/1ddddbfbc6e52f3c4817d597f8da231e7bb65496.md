...
- Name: spec\signIn.spec.js >> Sign-Up Flow >> SI-003: Verify user navigates back and forth to the signup screen from login screen
- Location: tests\spec\signIn.spec.js:33:9
